...
pub fn recurring_rule_update(
    ...
    let next_pomodoro_duration = payload
        .pomodoro_duration
        .unwrap_or(existing.pomodoro_duration);
    ...
    let normalized_repeat_days =
        normalize_repeat_days(&next_repeat_type, raw_repeat_days.as_deref())?;
